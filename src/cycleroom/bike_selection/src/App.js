...
const BikeSelection = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
            ...
            <Link to="/race" className="mt-6 text-blue-500 hover:underline">
                Go to Race Visualization
            </Link>
        </div>
    );
};
...
const App = () => {
    return (
        <Router>
            <Routes>
                <Route path="/bike-selection" element={<BikeSelection />} />
                <Route path="/race" element={<RaceVisualization />} />
            </Routes>
        </Router>
    );
};
