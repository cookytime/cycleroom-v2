...
class TestKeiserM3BLEBroadcast(unittest.TestCase):
    def test_initialization_and_parsing(self):
        ...
        data = mock_data[1]['manufacturerData']  # Sample manufacturerData from the mock data
        ...
        self.assertIsNone(broadcast_invalid.manufacture_data)  # Assuming the class handles it gracefully
